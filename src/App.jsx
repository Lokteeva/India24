...
return(  
 ...
 <div className='center-div'>
  ...
  <div className="center-div">
    <ul>
      ...
      <li>Внесите раннее бронирование в размере 5000 рублей до 30 июня.</li>
 ...
 <img className='img-Spring3' src='spr2.png' alt='img'/> 
  ...
  <div className='grid2col'>
    ...
    <h3 className='grid2col__h3R'>
    Желающие получить посвящение должны переслать весь пакет документов до 31 декабоя 2023 года  в Телеграмм бот: 
    <span style={{color: 'red'}}> @BBKS108_bot</span> и получить подтверждение, что документы получены, и вы включены в список преданных, которые будут получать пранаму или посвящение на ретрите.
    </h3>
  </div>
